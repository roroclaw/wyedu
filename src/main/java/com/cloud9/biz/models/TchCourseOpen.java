...
public class TchCourseOpen {
    ...
    public String getStuNumCount() {
        return stuNumCount;
    }

    public void setStuNumCount(String stuNumCount) {
        this.stuNumCount = stuNumCount;
    }
}