(function($) {
	...
	$.extend({
				 ...
				 *            请求结束执行函数
				 */
				ajaxConnSend : function(opt) {
					var target = opt['target'];
					var interfaceUrl = opt['interfaceUrl'];
					var params = opt['params'];
					var callbackFun = opt['callbackFun'];
					var endFun = opt['endFun'];
					var async = opt['async'];
					var isloading = opt['isloading'];
					...
					if(accToken == null || accToken == undefined || $.trim(accToken) == ''){
