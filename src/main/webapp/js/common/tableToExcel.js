...
function tableToExcel(tableid) {//整个表格拷贝到EXCEL中
    var excelFileName=$("#excelFileName").val()+'.xls';
    ...
    if(getExplorer()=='ie')
    {
        ...
        try {
            ...
            var fname = oXL.Application.GetSaveAsFilename(excelFileName, "Excel Spreadsheets (*.xls), *.xls");
        } catch (e) {
    ...
    {
        alert(excelFileName);
        console.debug(excelFileName);
        tableToExcel_m(tableid,excelFileName,'ssss');
    }
}
function Cleanup() {
