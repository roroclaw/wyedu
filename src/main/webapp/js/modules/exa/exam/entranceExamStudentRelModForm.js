...
$(function(){
  ...
  /*  ///////////响应下拉框选择
    ...
    $("#addBtn").click(function(){
        ...
        if(items.length>0){
            if (bol) {
                ...
                $.loadingBox.show();
                $.ajaxConnSend(this, 'scoExamScores/doAddEntranceExamStudentRel.infc', params, function(data) {
    ...
    var stuRelTable = $('#stuRelTable').mytable({
        ...
        params:{"openCourseId":courseOpenId,"scoreType":"4"},
        url: 'scoExamScores/doGetExamScoresPageDataByParam.infc',
        delFun: function(id) {
