     ...
     //   var tempenrolYear="";
      //  var tempTerm="";
       ...
       // $('#birthText_en').html(dateToEn(birthDate));
        ...
        $.loadingBox.show();
            $.ajaxConnSend(this, 'subjectScores/doGetStuScoreCertificateTableInfoCOByParam.infc', params, function(data) { ///////组建空表
               ...
               // console.debug(ScoreStuListObj[1]);
                var scStuScoreCertificateInfoList=ScoreStuListObj[1];///////科目列

                for(var j =0;j<scStuScoreCertificateInfoList.length;j++){
                    ...
                    tempHtml_a=tempHtml_a+'<tr><td style="width:100px;">'+scStuScoreCertificateInfoList[j].subjectText+'<br>'+scStuScoreCertificateInfoList[j].subjectTextEn+'</td>';
                    tempHtml_b=tempHtml_b+'<tr><td style="width:100px;">'+scStuScoreCertificateInfoList[j].subjectText+'<br>'+scStuScoreCertificateInfoList[j].subjectTextEn+'</td>';
                    for(var i =0;i<ScoreStuHeadList.length;i++){
                        tempHtml_a=tempHtml_a+'<td style="width:100px;" id="'+scStuScoreCertificateInfoList[j].subjectId+'_'+ScoreStuHeadList[i].schoolYear+'_1_a'+'"></td>' +
                        '<td style="width:100px;" id="'+scStuScoreCertificateInfoList[j].subjectId+'_'+ScoreStuHeadList[i].schoolYear+'_2_a'+'"></td>';
                        tempHtml_b=tempHtml_b+'<td style="width:100px;" id="'+scStuScoreCertificateInfoList[j].subjectId+'_'+ScoreStuHeadList[i].schoolYear+'_1_b'+'"></td>' +
                        '<td style="width:100px;" id="'+scStuScoreCertificateInfoList[j].subjectId+'_'+ScoreStuHeadList[i].schoolYear+'_2_b'+'"></td>';
                    }
                ...
                for(var  k=0;k<scStuScoreCertificateInfoList.length;k++){
                    $("#"+scStuScoreCertificateInfoList[k].subjectId+"_"+scStuScoreCertificateInfoList[k].schoolYear+"_"+scStuScoreCertificateInfoList[k].term+"_a").empty();
                    $("#"+scStuScoreCertificateInfoList[k].subjectId+"_"+scStuScoreCertificateInfoList[k].schoolYear+"_"+scStuScoreCertificateInfoList[k].term+"_a").html(scStuScoreCertificateInfoList[k].score);
                    $("#"+scStuScoreCertificateInfoList[k].subjectId+"_"+scStuScoreCertificateInfoList[k].schoolYear+"_"+scStuScoreCertificateInfoList[k].term+"_b").empty();
                    $("#"+scStuScoreCertificateInfoList[k].subjectId+"_"+scStuScoreCertificateInfoList[k].schoolYear+"_"+scStuScoreCertificateInfoList[k].term+"_b").html(scStuScoreCertificateInfoList[k].score);
                }
            }, function() {
                //alert("sdfsdf");
                $.loadingBox.close();
