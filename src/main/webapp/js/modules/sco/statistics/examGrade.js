...
$(function(){
    ...
    $('#calBtn').click(function(){
        ...
        if (bol) {
            ...
            $.loadingBox.show();
            $.ajaxConnSend(this, 'scoExamScores/calStatisticsDatas.infc', params, function(data) {
    ...
    $('#examGradeBtn').click(function(){
        ...
        //if (bol) {
            ...
            var url = BAS_URL + "scoExamScores/initPrintExamGrade.do?schoolYear=" + schoolYear + "&term=" + term + "&scoreType=" + scoreType + "&grade=" + grade;
            window.open(url);
        //}
    });
