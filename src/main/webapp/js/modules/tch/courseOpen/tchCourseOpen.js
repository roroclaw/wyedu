...
$(function(){
    ...
    $('#addBtn').click(function(){
        window.location.href = $.customOpt.url +'tch/courseOpen/courseOpenAddForm.html';
    });

    /**
     * 比对教学计划
     */
    $('#checkTCHPlan').click(function(){
            winOpen=window.open( BAS_URL+"tch/teachingPlan/tchTeachingPlanCourseOpens.html",'teachingPlanCourseOpenListForm');
    });
    ...
    $('#relMod').click(function(){
        ...
        if(items.length==1){
            window.location.href = BAS_URL+"courseOpen/initEditForCourseStudentRel.do?id="+items[0].id;
        }else{
