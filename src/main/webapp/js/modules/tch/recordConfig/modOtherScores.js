...
$(function(){
    ...
    var table = $('.dataTable').mytable({
        ...
        url: 'scoExamScores/doGetOtherExamScores4AdminModPageData.infc?examId='+$('#examId').val(),
        modFun:function(id) {//登记分数
            ...
            var showBox = $.showPopupForm('#recordScoreForm',function(){
                ...
                if (bol) {
                    ...
                    $.loadingBox.show();
                    $.ajaxConnSend(this, 'scoExamScores/doSetOtherScoresStatus.infc',formData, function(data) {
                        $.alert_success("设置成功!");
    ...
    $('#backBtn').click(function(){
        window.location.href = BAS_URL+'tch/recordConfig/otherRecordConfig.html';
    });
