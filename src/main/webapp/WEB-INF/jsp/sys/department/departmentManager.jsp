...
<div class="UI_main">
    ...
    <div id="divRowPart_1">
        <div class="col-md-4">
        <div class="UI_data">
            <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>部门</span></div>
        ...
        <div class="col-md-8">
        <div class="UI_data">
            <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>子部门列表</span></div>
    ...
    <script type="text/javascript" src="${contextpath}/js/modules/sys/department/departmentManager.js"></script>
