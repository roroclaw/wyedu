...
<div class="UI_main">
  ...
  <div class="UI_address">
    <span></span>
    <a href="###">学生管理</a><i>>></i><a href="###">学籍导入</a>
  </div>
  <!--系统地图 end-->
  ...
  <div id="divRowPart_1">
    <div class="col-md-12">
      <div class="UI_data">
        <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>学籍导入</span></div>
  ...
  <jsp:include page="../../common/simpleUploader.jsp" flush="true">
    <jsp:param value="学籍导入" name="titleName"/>
    <jsp:param value="上传excel" name="btnName"/>
    <jsp:param value="${contextpath}/student/importStudents.infc" name="url"/>
    <jsp:param value="xls,xlsx" name="extensions"/>
  </jsp:include>
  <!--内容数据end-->
  <script type="text/javascript" src="${contextpath}/js/modules/arc/student/arcStudentImp.js"></script>
