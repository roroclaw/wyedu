...
<div class="UI_main">
    ...
    <div class="UI_data UI_bd">
      <table style="width:100%">
        ...
        <tr>
          ...
          <td id="gradeSel" value="${stuInfo.grade}">
          </td>
          <td>民族<b style="color: #ff0000">*</b></td>
          <td id="nationSel" value="${stuInfo.nation}"></td>
        ...
        <tr>
          ...
          <td id="majorSel"  value="${stuInfo.majorId}">

          </td>
          <td>教学计划<b style="color: #ff0000">*</b></td>
          <td id="tchPlanSel" value="${stuInfo.tchPlanId}">
        ...
        <tr>
          ...
          <td id="classSel" value="${stuInfo.classId}"></td>
          <td >毕业学校</td>
  ...
  <script type="text/javascript" src="${contextpath}/js/modules/arc/student/studentModForm.js?rand=20171016"></script>
