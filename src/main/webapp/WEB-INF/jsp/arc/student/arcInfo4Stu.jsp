...
<div class="UI_main">
        ...
        <div class="UI_data UI_bd">
            <table style="width:100%">
                <tr>
                    ...
                    <td style="width:160px;"><input type="text" readonly class="" name="docId" value="${stuInfo.docId}"></td>
                    <td style="width:100px;">姓名</td>
                    <td><input type="text" readonly class="validate[required]" name="realName" value="${stuInfo.realName}"></td>
                ...
                <tr>
                    ...
                    <td>校内学号</td>
                    <td colspan="2"><input type="text" readonly name="stuNumber"  value="${stuInfo.stuNumber}" maxlength="32" class="validate[required]"></td>
                </tr>
                <tr>
    ...
    <script type="text/javascript" src="${contextpath}/js/modules/arc/student/arcInfo4Stu.js?rand=${jsRand}"></script>
