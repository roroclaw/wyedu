...
<div id="teacherSetBox" class="message_bg" style="display: none">
  <form id="teacherSetForm" class="dataForm">
    <input id="teacherSetForm_id" type="hidden" name="examId">
...
<script type="text/javascript" src="${contextpath}/js/modules/tch/recordConfig/otherRecordConfig.js?v=201801182"></script>
