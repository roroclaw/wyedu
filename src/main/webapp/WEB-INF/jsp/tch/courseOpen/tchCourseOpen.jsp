...
<div class="UI_main">
    ...
    <div class="operBar">
        ...
        <div class="oper_btn" id="relMod" style="cursor:pointer">学生编排</div>
        <div class="oper_btn_fun_1" id="checkTCHPlan" style="cursor:pointer">比对教学计划</div>
    </div>
    <!--内容数据end-->
    <script type="text/javascript" src="${contextpath}/js/modules/tch/courseOpen/tchCourseOpen.js"></script>
