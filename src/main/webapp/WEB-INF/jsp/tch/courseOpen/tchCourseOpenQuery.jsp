...
<div class="UI_main">
    ...
    <div class="UI_address">
        <span></span>
        <a href="###">教学管理</a><i>>></i><a href="###">开课查询</a>
    </div>
    <!--系统地图 end-->
    ...
    <div id="divRowPart_1">
        <div class="col-md-12">
            <div class="UI_data">
                <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>开课查询</span></div>
                <form id="queryForm">
    ...
    <!--内容数据end-->
    <script type="text/javascript" src="${contextpath}/js/modules/tch/courseOpen/tchCourseOpenQuery.js"></script>
