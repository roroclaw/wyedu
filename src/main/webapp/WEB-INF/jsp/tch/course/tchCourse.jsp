...
<div class="UI_main">
    ...
    <div class="UI_address">
        <span></span>
        <a href="###">教学管理</a><i>>></i><a href="###">课程管理</a>
    </div>
    <!--系统地图 end-->
                ...
                <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>课程管理</span></div>
                    <form id="queryForm">
                        <div class="data_box clear">
                            ...
                            <!--下拉框 star-->
                            <div class="data_input" id="subjectType_select_add">
                                <span>所属科目类型：</span>
                            </div>
                            <div class="data_input">
                                <span>所属科目：</span>
    ...
    <!--内容数据end-->
    <script type="text/javascript" src="${contextpath}/js/modules/tch/course/tchCourse.js"></script>
