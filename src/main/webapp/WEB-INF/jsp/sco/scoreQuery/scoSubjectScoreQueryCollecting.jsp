...
<div class="UI_main">
        ...
        <div class="UI_address">
            <span></span>
            <a href="###">成绩管理</a><i>>></i><a href="###">总评成绩汇总查询</a>
        </div>
    <!--数据显示区域 star-->
    <div class="UI_data ">
        <div class="data_title clear"><i class="iconfont icon-hangbiao"></i><span>总评成绩汇总查询</span></div>
        <form id="queryForm">
    ...
    <script type="text/javascript" src="${contextpath}/js/modules/sco/scoreQuery/scoSubjectScoreQueryCollecting.js"></script>
