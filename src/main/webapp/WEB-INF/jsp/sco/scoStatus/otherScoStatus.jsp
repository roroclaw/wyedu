...
<div class="UI_main">
  ...
  <div class="UI_address">
    <span></span>
    <a href="###">成绩管理</a><i>>></i><a href="###">(${vRecordConfig.planText}-${vRecordConfig.subjectText})缺缓考登记</a>
  </div>
  <!--系统地图 end-->
...
<!--内容数据end-->
<script type="text/javascript" src="${contextpath}/js/modules/sco/scoStatus/otherScoStatus.js?v=20180116"></script>
