  ...
  <form id="dataForm" action="">
    <div class="UI_data UIfrom">
      <div class="data_input"><span>学员：</span>
        <input id="stuNameSel" placeholder="输入学号过滤选择" name="stuName" type="text"  class="validate[required]"/><i>*</i>
      </div>
      <div class="clear"></div>
      <div class="data_input"><span>班级：</span>
        <input id="className"  name="className" type="text"  readonly="true"/>
      </div>
      <div class="clear"></div>
      <!--下拉框 star-->
      <div class="data_input">
        ...
        <div class="select_box">
          <select id="subjectSel" name="subjectId" class="validate[required]">
      ...
      <div class="data_input"><span>分数：</span>
        <input name="score" type="text"  class="validate[required,custom[integer]]"/><i>*</i>
      </div>
      <div class="clear"></div>
...
<script type="text/javascript" src="${contextpath}/js/modules/sco/scores/subjectScoreAddForm.js"></script>
