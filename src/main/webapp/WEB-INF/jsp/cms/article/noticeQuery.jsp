...
<div class="UI_main">
    ...
    <div class="form_operbar clear">
        ...
        <div class="oper_btn_fanhui" id="teacherNotice" style="cursor:pointer">教师公告</div>
        <div class="oper_btn_fanhui" id="classNotice" style="cursor:pointer">班级公告</div>
    </div>
    <!--数据显示区域 star-->
    <div id="divRowPart_1">
        <div class="col-md-12">
    ...
    <!--内容数据end-->
    <script type="text/javascript" src="${contextpath}/js/modules/cms/noticeQuery.js"></script>
